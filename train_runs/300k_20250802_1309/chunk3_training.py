#!/usr/bin/env python3
"""
Chunk 3 Training - 2,048 steps from chunk 2 checkpoint
"""
...
def main():
    try:
        print("🚀 STARTING CHUNK 3 TRAINING - 2,048 STEPS")
        print("=" * 60)
        ...
        # Configuration
        config = {
            'checkpoint_path': 'train_runs/300k_20250802_1309/checkpoints/chunk2_final_204800steps.zip',
            'chunk_size': 2048,  # Larger chunk - 2,048 steps
        ...
        # Load checkpoint from chunk 2
        print(f'🤖 Loading checkpoint from chunk 2...')
        ...
        class ChunkCallback(BaseCallback):
            ...
            def _on_step(self) -> bool:
                ...
                # Progress updates every 256 steps
                if steps_in_chunk % 256 == 0 and steps_in_chunk > 0:
        ...
        print('🎉 CHUNK 3 TRAINING COMPLETED SUCCESSFULLY!')
        print(f'💡 Progress: 201K → {final_steps:,} steps')
        print(f'💡 Total training so far: {final_steps - 201200:,} steps')
        print(f'💡 Next: Run chunk 4 to continue toward 300K')
        
    except Exception as e:
        print(f"❌ Chunk 3 training failed with error: {e}")
