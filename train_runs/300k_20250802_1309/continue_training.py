#!/usr/bin/env python3
"""
Continue Training from Checkpoint - Chunk 2
"""
...
def main():
    try:
        print("🚀 CONTINUING TRAINING FROM CHECKPOINT - CHUNK 2")
        print("=" * 60)
        ...
        # Configuration
        config = {
            'checkpoint_path': 'train_runs/300k_20250802_1309/checkpoints/chunk1_final_203000steps.zip',
            'chunk_size': 1800,  # Train another 1800 steps
            'save_dir': 'train_runs/300k_20250802_1309/checkpoints',
            'current_chunk': 2  # This is chunk 2
        }
        ...
        # Load checkpoint
        print(f'🤖 Loading checkpoint from chunk 1...')
        ...
        print('🎉 CHUNK 2 TRAINING COMPLETED SUCCESSFULLY!')
