...
class ReallyWorkingSecretsManager:
    """Secrets manager that actually works by storing salt with each secret"""
...
if __name__ == "__main__":
    ...
    manager = ReallyWorkingSecretsManager(new_vault_path, password)
    ...
    if api_key:
        ...
        if success:
            ...
            if retrieved == api_key:
                ...
                manager2 = ReallyWorkingSecretsManager(new_vault_path, password)
