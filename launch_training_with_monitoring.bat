...
start "TensorBoard-GPU-Fixed" cmd /k "cd /d C:\Projects\IntradayJules && call venv_fresh\Scripts\activate.bat && tensorboard --logdir logs\tensorboard_gpu_fixed --port 6006 --host 0.0.0.0"
