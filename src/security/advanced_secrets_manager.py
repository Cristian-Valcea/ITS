...
class AdvancedSecretsManager:
    ...
    async def write_secret(self, key: str, value: str, 
        ...
        Args:
            ...
            metadata_dict: Optional metadata dictionary (legacy support)
        ...
        try:
            ...
            # Handle both new parameter style and legacy metadata_dict style
            if metadata_dict:
                # Legacy style - extract from metadata_dict
                ...
                # New style - use individual parameters
    ...
    async def read_secret(self, key: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Decrypt the value
            # The value is stored as base64, so decode it first
            storage_data = base64.b64decode(secret_data.value.encode('utf-8'))
